...
class Leon:
    ...
    def __init__(self):
        ...
        self.PAtacarDependiendoLaPosicion = [ 0,0,0,0,0,0 ]
...
def CalcularProbabilidades():
    ...
    vecesQueMurio = []
    contadorPorPosicion = [ 0,0,0,0,0,0 ]
    PAtaqueExitosoEnLaPosicion = [ 0,0,0,0,0,0 ]
...
def accionesLeon():
    ...
    #print("Ya en accionesLeon() despues de verificar estado impala la distancia entre ambos es: ", 7 - myLeon.distanciaRecorrida)
    ...
    #print("Ya en accionesLeon() despues de verificar zona segura la distancia entre ambos es: ", 7 - myLeon.distanciaRecorrida)
    ...
    #print("Ya en accionesLeon() despues de calcular probabilidades  la distancia entre ambos es: ", 7 - myLeon.distanciaRecorrida)
    ...
    if myLeon.zonaSegura == True:
        ...
        #print("Ya en accionesLeon() despues de zona segura true  la distancia entre ambos es: ", 7 - myLeon.distanciaRecorrida)

    #En el rango de visión del impala
    else:

        #print("Ya en accionesLeon() entrando a  zona segura false  la distancia entre ambos es: ", 7 - myLeon.distanciaRecorrida)
        #Seleccionamos la mejor probabilidad que puede tomar el León
        ...
        #print("Ya en accionesLeon() despues de zona segura false  la distancia entre ambos es: ", 7 - myLeon.distanciaRecorrida)
...
def accionImpala():
    ...
    if  myLeon.PAtacarDependiendoLaPosicion[ (7-myLeon.distanciaRecorrida) - 2 ]  > 0 or ( 7-myLeon.distanciaRecorrida == 2 and myLeon.estado == "Atacando"):
    ...
    if ( myLeon.zonaSegura == False and myLeon.estado == "Avanzando" ) or ( 7 - myLeon.distanciaRecorrida < 3) or (myLeon.estado == "Atacando"):
        myImpala.huir()
...
def transcursoEventos( contador, numeroDeReinicio ):
    ...
    if contador == 1:
        ...
        print("Distancia entre ambos: ",7 - myLeon.distanciaRecorrida," bloques")
    ...
    if myImpala.estado == "Muerto":
        ...
        #print("Antes de entrar a accionesLeon() la distancia entre ambos es: ", 7 - myLeon.distanciaRecorrida)
        accionesLeon()
    #print("Después de sali de accionesLeon() la distancia entre ambos es: ", 7 - myLeon.distanciaRecorrida)
    ...
    if len(arrayDistanciaEntreAmbos) == 0:
        ...
        archivoTexto4.write( str(7 - myLeon.distanciaRecorrida) )
 
    else:
        
        archivoTexto4.write( "\n" + str(7 - myLeon.distanciaRecorrida) )
...
def MenuPrincipal():
    ...
    if opcion == 2:
        ...
        myProcesoActual.tipoDeEjecución = "Cazeria"
